...
export default class Game extends Phaser.State {
  ...
  create() {
    ...
    this.grass = this.game.add.isoSprite(0, 66, 0, 'grass_border');
    this.grass = this.game.add.isoSprite(0, 132, 0, 'grass_border');
    this.grass = this.game.add.isoSprite(0, 198, 0, 'grass_border');
    this.grass = this.game.add.isoSprite(0, 264, 0, 'grass_border');
    this.grass = this.game.add.isoSprite(0, 330, 0, 'grass_border');
    // this.grass = this.game.add.isoSprite(0, 384, 0, 'grass_large');
    // this.grass = this.game.add.isoSprite(0, 448, 0, 'grass_large');
    // this.grass = this.game.add.isoSprite(0, 512, 0, 'grass_large');
    // this.grass = this.game.add.isoSprite(0, 576, 0, 'grass_large');
